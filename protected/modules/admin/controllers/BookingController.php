...
class BookingController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','create','update','admin','delete','denied','confirmed'),
	...
	public function actionView($id)
	{
		...
		if(isset($_POST['btnConfirm'])){
			$model->replied = Booking::REPLY_CONFIRMED;
			$model->save(false);
			$this->redirect(array('booking/admin'));
		}
		if(isset($_POST['btnDeny'])){
			$model->replied = Booking::REPLY_DENIED;
			$model->save(false);
...
//		));
	...
	{
		$model=new Booking('searchConfirmed');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Booking']))
			$model->attributes=$_GET['Booking'];
	...
	{
		$model=new Booking('searchDenied');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Booking']))
			$model->attributes=$_GET['Booking'];
